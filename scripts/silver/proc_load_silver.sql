...
BEGIN
    ...
    BEGIN TRY
        ...
        CASE 
            WHEN TRIM(UPPER(cst_gndr)) = 'F' THEN 'Femanle'
        ...
        SELECT 
            ...
            CASE -- replace CHAR(13) ->\r or CHAR(10) ->\n 
        ...
        SELECT 
            REPLACE (cid, '-', '') AS cid,
            CASE 
                    WHEN cntry_cleaned IN ('DE', 'GERMANY') THEN 'Germany'
                    WHEN cntry_cleaned IN ('US', 'USA') THEN 'United States'
                    WHEN cntry_cleaned = '' OR cntry_cleaned IS NULL THEN 'n/a'
                    ELSE cntry_cleaned
            END AS cntry -- Normalize and Handle missing or blank country codes
        FROM( 
            -- CTAS to handling hidden carriage returns \r and newlines \n 
            SELECT
            *,
            TRIM(REPLACE(REPLACE(cntry, CHAR(13), ''), CHAR(10), '')) AS cntry_cleaned
